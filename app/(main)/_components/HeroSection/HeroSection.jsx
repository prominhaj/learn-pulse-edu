...
const HeroSection = () => {
    return (
        <>
            <section
                className="py-12 sm:py-20 md:py-28 lg:py-40 
                relative lg:-mt-16 w-full overflow-hidden overflow-x-clip bg-slate-50 bg-gradient-to-t from-slate-50 to-slate-100 dark:bg-[#0B1120] dark:bg-none"
            >
